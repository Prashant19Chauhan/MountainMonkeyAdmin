...
import { 
  XCircle, Plus, Save, Trash2, ArrowUp, ArrowDown, 
...
import { getPackageDetailSectionsApi, updatePackageDetailSectionsApi } from '@/services/package.service';
...
export default function PackageDetail() {
  ...
  const fetchCmsSections = async () => {
    ...
    setCmsLoading(true);
    try {
      const data = await getPackageDetailSectionsApi(packageId);
  ...
  const handleSave = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      await updatePackageDetailSectionsApi(packageId, { customSections });
        ...
        <div className="mt-10 pb-10">
          <div className="mb-8 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-slate-500 font-medium text-sm">Add rich content blocks shown at the bottom of this package&apos;s detail page.</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
          ...
          {customSections.length === 0 ? (
            <div className="bg-white rounded-3xl border border-slate-100 p-14 text-center text-slate-400 shadow-sm space-y-3">
              ...
              <p className="text-slate-500 text-xs font-medium max-w-xs mx-auto">Click &quot;Add Block&quot; to build engaging content for this package&apos;s detail page.</p>
            </div>
          ) : (
